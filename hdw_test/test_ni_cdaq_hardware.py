...
ANALOG_CHANNELS = {
    ...
    "pressure_post_ms": {"channel": f"{NI_9253_SLOT}/ai4", "name": "Post MS Pressure", "range": [0, 1.012], "units": "PSI"},
    "pressure_pre_ms": {"channel": f"{NI_9253_SLOT}/ai5", "name": "Pre MS Pressure", "range": [0, 1.012], "units": "PSI"},
    "pressure_h2_bp": {"channel": f"{NI_9253_SLOT}/ai6", "name": "H2 Back Pressure", "range": [0, 1.012], "units": "PSI"},
}
